...
export const Footer: EditableComponent<FooterProps> = ({ links }) => {
  return (
    <footer className="px-10 pt-8 pb-25 md:pt-5 md:pb-4 md:px-7 lg:pt-7 lg:pb-6 lg:px-11 flex flex-col md:flex-row justify-between items-center border border-black-30 rounded-t-3xl">
